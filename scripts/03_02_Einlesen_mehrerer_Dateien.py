...
# Das Modul glob bietet die Möglichkeit, mit den Shell-Wildcards zu arbeiten. So
# lassen sich zum Beispiel alle Dateien, deren Name  mit 'test' beginnt und die
# die Endung '.txt' haben, in der Liste files speichern.
...
# Anstatt die einzelnen Arrays nur auszugeben, lassen sich diese beispielsweise
# auch in einer Liste abspeichern. Hierzu muss die Liste vorher deklariert
# werden. Im Anschluss kann der eingelesene Array mit der Funktion append an die
