...
# Eingangsvariablen sind die erzeugte time Variable und die y-Werte.
# Zusätzlich wird angegeben, welche Variablen ein Datumsformat sind.
# Der Parameter definiert den Plot (hier blaue Punkte).
fig, ax = plt.subplots()
ax.plot_date(time, data['M40V02'], xdate=True, ydate=False, fmt='bo')
ax.set_ylabel('Windgeschwindigkeit')
ax.set_xlabel('Uhrzeit')

# Mit dem DateFormatter lässt sich das auf der Achse angezeigte
