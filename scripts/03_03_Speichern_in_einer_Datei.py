...
# Es ist sinnvoll seinem Datensatz eine Kopfzeile (header) hinzuzufügen,
# in der der Inhalt der Datei beschrieben wird.  Die Headerzeile ist per
# default ein Kommentar; ihr wird ein # vorangestellt.  Möchte man
# dieses Verhalten umgehen, kann man dies mit dem Keyword comments=None
# ausschalten.
header = 'A,B,C,D,E'
